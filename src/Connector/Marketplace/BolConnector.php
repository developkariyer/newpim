...
class BolConnector
{
    ...
    public funtion __construct($marketplaceKey)
    {
        $this->httpClient = HttpClient::create();
        $this->clientId = $_ENV[$marketplaceKey . '_CLIENT_ID'];
        $this->secretKey = $_ENV[$marketplaceKey . '_SECRET'];
    }
    ...
    {
        if (!Utility::checkJwtTokenValidity($this->token)) {
